...
function save(s) { try { atomicWriteJson(STATE_FILE, s); _cache = s; } catch (e) { _cache = s; console.error('[arena] SAVE FAILED - state is IN MEMORY ONLY and will be lost on restart:', e.message); } }
