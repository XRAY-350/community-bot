...
function save(s) { try { atomicWriteJson(FILE, s); _cache = s; } catch (e) { _cache = s; console.error('[awards] SAVE FAILED - state is IN MEMORY ONLY and will be lost on restart:', e.message); } }
