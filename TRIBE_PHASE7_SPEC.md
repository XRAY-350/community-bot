...
- [x] 5. Herald voice + polish — copy.js gains a `herald` section (one narrator voice: rotating proclamation openers + fixed sign-off, plus a shared COLOR palette and ICON set per concept). Coronation + Chronicle now speak in the Herald voice; recognition embeds pull the shared palette. All 5 grandeur phases shipped
