...
// Re-entrancy guard (audit A24): a send pass slower than the 2-min interval (rate limits on a busy day)
// let the next tick re-read the stale watermark and re-post the same audit entries.
let _pollBusy = false;
