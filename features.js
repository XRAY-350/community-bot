...
const REGISTRY = [
  ...
  { key: 'smartWatch',   audience: 'core',   built: false }, // LLM contextual judge on the watch pipeline - cuts keyword false positives (needs ANTHROPIC_API_KEY; shadow-mode-first via SMARTWATCH_LIVE)
