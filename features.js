...
const REGISTRY = [
  ...
  { key: 'modapps',     audience: 'member', built: true,  commands: ['apply-mod', 'demote-trial', 'mod-applications', 'promote-trial', 'promote-mod'],   // apply-mod-setup → /panel Setup. mod-applications/promote-trial/promote-mod were all BUILT (full SlashCommandBuilder + handlers) but missing from this list, so Discord never registered any of them — same class of bug as the /ban registry gap (2026-08-14). All 3 also reachable via /panel (Actions/Promotions).
