...
async function submit(guild, member, text, choice) { return withLock('whistleblow', () => _submit(guild, member, text, choice)); }
async function _submit(guild, member, text, choice) {
  const c = loadConfig();
